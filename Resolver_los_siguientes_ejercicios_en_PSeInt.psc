...
funcion ejercicio8
	...
	escribir " ingrese una cantidad de lápices"
...
Funcion ejercicio9
	...
	Escribir "El precio final por el traje es:" ,precio
...
Funcion ejecicio10
	...
	definir total Como Real
	Escribir "Ingresa el número de platillos"
	leer n
	si n > 300 Entonces
		total = 75.00 * n
	SiNo
...
Funcion ejercicio14
	...
	Escribir "El total a pagar por ",num," lapices es: ",total
FinFuncion
...
funcion ejercicio24
	...
	Si num>=1 Y num<=12 Entonces
		...
		SiNo
			...
			FinSi
		FinSi
		Escribir 'al numero ',num,' le corresponde el mes ',mes
	SiNo
		Escribir 'ingrese numero del 1 al 12'
	FinSi
FinFuncion
